...
def get_args():
    ...
    parser.add_argument('--lr-schedule', default='piecewise', choices=['superconverge', 'piecewise', 'linear', 'piecewisesmoothed', 'piecewisezoom', 'onedrop', 'multipledecay', 'cosine','fixed'])
    ...
    parser.add_argument('--fname', default='jws_cifar10_model', type=str)
...
def main():
    ...
    opt = torch.optim.SGD(params, lr=args.lr_max, momentum=0.9, weight_decay=args.wd)
